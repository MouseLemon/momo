                    ...
                    ,events = function(reElem, disabled, isSearch){
                            ...
                            ,hideDown = function(choose){
                                ...
                                notOption(input.val(), function(none){
                                    ...
                                    if(none){
                                        ...
                                        if(input.parents('.layui-form-select').prev().attr('id')!='searchSpecial'){//2018.12.7特殊搜索下拉框的修改
                                            input.val(initValue || '');
                                        }
                        ...
                        if(isSearch){
                            input.on('keyup', search).on('blur', function(e){
                                if(input.parents('.layui-form-select').prev().attr('id')!='searchSpecial'){
                                    var selectedIndex = select[0].selectedIndex;
